...
def add_to_calculation(symbol):
    ...
    text_result.delete(1.0, "end")  # Clear the previous content
...
bt_minus = tk.Button(root, text="-", command=lambda: add_to_calculation("-"), width=5, font=("Arial", 14))
...
bt_equals = tk.Button(root, text="=", command=evaluate_calculation, width=11, font=("Arial", 14))
